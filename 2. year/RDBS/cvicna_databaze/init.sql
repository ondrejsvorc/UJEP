...
CREATE TABLE pozice (
  ...
  plat INT NOT NULL CHECK (plat >= 0),
  id_poz_nad INT
);
...
CREATE TABLE zamestnanci (
  ...
  id_poz INT NOT NULL,
  odmena INT NOT NULL CHECK (odmena >= 0),
